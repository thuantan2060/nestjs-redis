...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/thuantan2060/nestjs-redis/issues">Report Bug</a>
    ·
...
```sh
# with npm
npm install @nestjs/terminus @thuantan2060/nestjs-redis-health ioredis
# with yarn
yarn add @nestjs/terminus @thuantan2060/nestjs-redis-health ioredis
# with pnpm
pnpm add @nestjs/terminus @thuantan2060/nestjs-redis-health ioredis
```
...
import { RedisHealthModule } from '@thuantan2060/nestjs-redis-health';
...
import { RedisHealthIndicator } from '@thuantan2060/nestjs-redis-health';
